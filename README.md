...
- **Native AOT**: Built with .NET 9 AOT for fast startup and reduced memory footprint (24.7 MB container)
...
image:
  repository: ghcr.io/your-org/rancher-devops-operator
  tag: "latest"
```
...
- **AOT Compilation**: Uses .NET Native AOT for optimal performance
